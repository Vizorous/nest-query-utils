...
export type CreateReturn<T extends BaseEntity> = Omit<
	T,
	"id" | "createdAt" | "updatedAt"
>;
export type CreateReturnWOmit<T extends BaseEntity, K extends keyof T> = Omit<
	T,
	"id" | "createdAt" | "updatedAt" | K
>;

export type CreateTypeReturn<T extends BaseEntity> = Type<CreateReturn<T>>;
export type CreateTypeReturnWOmit<
	T extends BaseEntity,
	K extends keyof T
> = Type<CreateReturnWOmit<T, K>>;
 ...
 */
export function CreateType<T extends BaseEntity>(
	classRef: Type<T>
): CreateTypeReturn<T>;
 ...
 */
export function UpdateType<T extends BaseEntity>(
	classRef: Type<T>
